...
object Instructions {
  ...
  //  def SD             = BitPat("b?????????????????011?????0100011")
  //  def ADD            = BitPat("b0000000??????????000?????0110011")
  def gen_key            = BitPat("b1000000??????????000?????0110011")
  // def cc_isa_encptr      = BitPat("b1100000??????????000?????0110011")
  def load_key           = BitPat("b?????????????????111?????0000011")
  def store_key          = BitPat("b?????????????????111?????0100011")
