...
import freechips.rocketchip.rocket.{ICacheParams, DCacheParams, BTBParams, ASIdBits, VMIdBits, TraceAux, BPWatch, CacheCryptoConfigBundle}
    ...
    with HasNonDiplomaticTileParameters
{
  ...
  /** Node for propagating cache-crypto runtime configuration toward lower cache levels. */
  val cacheCryptoConfigSourceNode = BundleBridgeSource(() => new CacheCryptoConfigBundle)
