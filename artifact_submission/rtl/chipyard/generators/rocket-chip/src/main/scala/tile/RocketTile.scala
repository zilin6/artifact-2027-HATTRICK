...
class RocketTileModuleImp(outer: RocketTile) extends BaseTileModuleImp(outer)
  ...
  outer.cacheCryptoConfigSourceNode.bundle.enable := false.B
  outer.cacheCryptoConfigSourceNode.bundle.enable_wen := false.B
  outer.cacheCryptoConfigSourceNode.bundle.base := 0.U
  outer.cacheCryptoConfigSourceNode.bundle.base_wen := false.B
