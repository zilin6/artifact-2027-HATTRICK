...
module asconaead24(
    ...
    input  logic [ 23:0]    in_msg,

    output logic [ 23:0]    out_msg,
    ...
    // Message XOR
    assign msg_xor_0_enc = state_dom_sep[0] ^ {39'b0, 1'b1, in_msg[23:0]};
    assign msg_xor_1_enc = state_dom_sep[1];
    assign msg_xor_0_dec = {state_dom_sep[0][63:25], ~state_dom_sep[0][24], in_msg[23:0]};
    assign msg_xor_1_dec = state_dom_sep[1];
