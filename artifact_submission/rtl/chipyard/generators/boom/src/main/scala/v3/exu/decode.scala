...
object XDecode extends DecodeConstants
{
  ...
  gen_key -> List(Y, N, X, uop_gen_key  , IQT_INT, FU_ALU , RT_X  , RT_X  , RT_X  , N, IS_X, N, N, N, N, N, M_X  , 0.U, N, N, N, Y, N, CSR.N),
   //LD    -> List(Y, N, X, uopLD   , IQT_MEM, FU_MEM , RT_FIX, RT_FIX, RT_X  , N, IS_I, Y, N, N, N, N, M_XRD, 3.U, N, N, N, N, N, CSR.N),
  load_key-> List(Y, N, X, uop_load_key , IQT_MEM, FU_MEM , RT_X  , RT_FIX, RT_X  , N, IS_I, Y, N, N, N, N, M_XRD, 3.U, N, N, N, Y, N, CSR.N),
  //                                                                                                    内存写入
  //SD     ->List(Y, N, X, uopSTA  , IQT_MEM, FU_MEM , RT_X  , RT_FIX, RT_FIX, N, IS_S, N, Y, N, N, N, M_XWR, 0.U, N, N, N, N, N, CSR.N),
  // 自定义的store_key就不需要拆分为 sta和std了
  store_key->List(Y, N, X, uop_store_key, IQT_MEM, FU_MEM , RT_X  , RT_FIX, RT_X  , N, IS_S, N, Y, N, N, N, M_XWR, 0.U, N, N, N, Y, N, CSR.N),
